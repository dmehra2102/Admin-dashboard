...
export const CompanyList = () => {
  const go = useGo();
  const { tableProps, filters } = useTable<CompaniesListQuery, HttpError, ISearch>({
    resource: "companies",
    onSearch: (value) => {
    ...
    >
      ...
      >
        ...
        <Table.Column<Company>
          ...
          render={(value, company) => <Text>{currencyNumber(company?.dealsAggregate?.[0].sum?.value || 0)}</Text>}
        />
