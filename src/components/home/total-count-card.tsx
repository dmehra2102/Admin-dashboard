...
const DashboardTotalCountCard = ({ resource, isLoading, totalCount }: Props) => {
  const { primaryColor, icon, secondaryColor, title } = totalCountVariants[resource];
  ...
  return (
    <Card style={{ height: "96px", padding: 0 }} size="small" bodyStyle={{ padding: "8px 8px 8px 12px" }}>
      <div
        style={{
          display: "flex",
